...
ws.send('{"jsonrpc":"2.0","method":"gdoModuleCommand","params":{"msgType":16,"moduleType":5,"portId":7,"moduleMsg":{"doorCommand":1},"topic":"DEVICE_ID_GOES_HERE"}}'); //CHANGE DEVICE ID
ws.ping();
console.log('OPENING');
});
